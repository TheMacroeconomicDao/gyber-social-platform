    ...
    periods: [
      ...
      },
      {
        ...
        items: [
          {
            title:
              'Prototype of GyberComputer (Decentralized, Multi-platform, Computing Cluster) Development',
            status: IconStatus.DEFAULT,
          },
          {
            title:
      ...
      },
      {
        ...
        items: [
          ...
          {
            title: 'TheMacroeconomicDAO Smart Contracts Deploy ',
            status: IconStatus.DEFAULT,
          },
          {
    ...
    periods: [
      {
        ...
        items: [
          ...
          {
            title: 'GyberPlan (Task Manager) Testing',
            status: IconStatus.DEFAULT,
          },
          {
      ...
      },
      {
        ...
        items: [
          ...
          {
            title:
              ' GyberComputer (Decentralized, Multi-platform, Computing Cluster) Development',
            status: IconStatus.DEFAULT,
          },
          {
            title:
              'GyberNet (Decentralized, Multi-platform BlockChain) Development',
            status: IconStatus.DEFAULT,
          },
        ],
      },
      {
        ...
        items: [
          ...
          {
            title:
              'GyberNet (Decentralized, Multi-platform BlockChain) TestNet Release',
            status: IconStatus.DEFAULT,
          },
        ],
      },
      {
        ...
        items: [
          {
            title:
              ' GyberComputer (Decentralized, Multi-platform, Computing Cluster) TestNet Release',
            status: IconStatus.DEFAULT,
          },
          {
            title:
          ...
          {
            title: 'Testing Linux Virtual Machine Under Blockchain Control',
            status: IconStatus.DEFAULT,
          },
        ],
      },
