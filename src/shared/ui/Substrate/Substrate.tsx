...
export const Substrate = (props: SubstrateProps) => {
  const { className = "", title, subtitle, text, scrollable = true, buttonText, buttonLink } = props;
  return (
    <>
      <div className={classNames(cls.Substrate, {[cls.with_button]: !!buttonText && !!buttonLink}, [className])}>
        <h2>{title}</h2>
